...
const defaultMenu = {
  before: `*${ucapan()} ${conn.getName(m.sender)}*
*U S E R  I N F O*
 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	{title: `🎭 › 𐐪-» Anonymous chat «`, rowId: ".anonymous", description: "╰► Mau ngomong sama mantan kah? >.<"},
	...
	{title: `🦄 › 𐐪-» Group «`, rowId: ".group", description: "╰► Menu settingan buat group mu kak -??"},
